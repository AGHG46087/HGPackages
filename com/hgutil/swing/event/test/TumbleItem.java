 ...
 * @author:		hgrein
 * date:		Feb 3, 2004
 * Package:		com.hgutil.swing.event.test
 * File Name:		TumbleItem.java
 */
package com.hgutil.swing.event.test;
...
import com.hgutil.swing.event.SwingWorker;
 ...
 * author:      hgrein<BR>
 * date:        Feb 3, 2004<BR>
 * Package:     com.hgutil.swing.event.test<BR>
 * File Name:   TumbleItem.java<BR>
 * Type Name:   TumbleItem<BR>
 * Description: 
 * TumbleItem.java requires these files:
 *   <B>SwingWorker.java</B>
...
implements ActionListener
{
  ...
  private static final long serialVersionUID = 3689070659808539703L;
  ...
  /**
   * 
   * @uml.property name="animator"
   * @uml.associationEnd multiplicity="(0 1)" inverse="this$0:com.hgutil.swing.event.test.TumbleItem$Animator"
   */
  Animator animator; //the applet's content pane

  /**
   * 
   * @uml.property name="imgs"
   * @uml.associationEnd multiplicity="(0 -1)"
   */
  ...
  {
    /** Field <code>serialVersionUID</code> : long */
    private static final long serialVersionUID = 4120851070730778675L;
    public Animator()
    {
